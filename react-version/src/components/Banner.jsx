          ...
          <div className="container">
              <div className="banner-wrap" id="home">
                  <ul className="d-flex social banner-social">
                      ...
                      <li>
                          <a href="assets\chirag-waghela-resume.pdf" download className="resume">
                  ...
                  <div className="content-wrap">
                      <div className="banner-inner" data-aos="fade-up" data-aos-delay="0">
                          ...
                          <div className="dash-wrap">
                              <h2 className="dash">Chirag Waghela</h2>
                          </div>
                      </div>
                      <div className="type-text">
                          <span
                              className="txt-rotate" data-period="300" data-rotate='[ "HTML", "Css", "Javascript", "Wordpress", "SCSS", "Tailwind", "Vue.js", "PHP", "Blade" ]'></span>
                      </div>
                  </div>
              </div>
          </div>
